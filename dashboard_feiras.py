...
# --- EXECUÇÃO PRINCIPAL ---
NOME_ARQUIVO = "dados.csv" # Usando o nome simples e perfeito
...
try:
    ...
    st.error(f"ERRO: O Python não encontrou o arquivo '{NOME_ARQUIVO}'.")
    st.warning("Verifique na lista da 'Ferramenta de Diagnóstico' (acima) se o nome 'dados.csv' aparece.")
    st.info("Se não aparecer, significa que o arquivo não foi renomeado corretamente ou não está na mesma pasta do script.")
except Exception as e:
